...
export interface Wizard<E, A>
  extends Newtype<{ readonly Wizard: unique symbol }, F.Form<E, A>> {}
...
export const step = <E, A>(form: F.Form<E, A>): Wizard<E, A> =>
  getIsoWizard<E, A>().wrap(form);
export const wizard = <E, A>(wiz: Wizard<E, A>): F.Form<E, A> =>
  getIsoWizard<E, A>().unwrap(wiz);
